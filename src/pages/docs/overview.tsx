...
export default function Overview() {
  return (
    <DocsScreenLayout>
      ...
      <Text>
        Your application (and therefore it's design system) also never stop changing. New
        features necessitate new patterns and every now and then a company re-brand comes
        along...{' '}
      ...
      <Text>
        ...
        <span className='italic'>but</span> you also want a sensible set of constraints in
        place to make consistency easy, <span className='italic'>and</span> you need the
        entire solution to be performant.
      </Text>
      <Text>
        ...
        Before looking at the goals of Componentry let's look more closely at some of the
        common difficulties faced working with design system solutions.
      </Text>
      {/* --- SECTION  */}
      ...
      <Text>
        This problem can be most apparent when using CSS frameworks that expose SASS/LESS
        variables for customizing styles. Not every style can be overridden this way which
        can lead to layering of overrides that is difficult to track.
      </Text>
      <Text>
      ...
      <Text>
        ...
        experience begins to diverge.This introduces a natural friction between providing
      ...
      <Text>
        ...
        for overrides, it also means that each engineer is responsible for correctly using
        the right utilities in the right ways.
      </Text>
      <Text>
      ...
      <Text>
        Using components for all of your application elements can make consistency easy by
        providing the guardrails that make it clear how to work in your system. But using
        components for every single element in a screen can have performance overhead.
      </Text>
      <Text>
        This problem can be most apparent using CSS in JS libraries. They provide 100%
        customizable base styles, and utility props that can accept any value at runtime,
        but with enough components rendered there can start to be a slight lag.
      </Text>
      <Text>
      ...
      <Text>
        ...
        overhead as possible to keep your application <span className='italic'>FAST</span>
        .
      </Text>
      {/* --- SECTION  */}
      <Text variant='h2'>Componentry</Text>
      <Text>
        Componentry styles are 100% customizable thanks to some magic from PostCSS. You're
        able to define style overrides as an object and can change or remove any line of
        CSS in the library.
      </Text>
      <Text>
      ...
      <Text>
        A close integration with Tailwind provides the ability to quickly create features
        by composing a set of well structured design system elements, adjusted to the
        specific needs with utility classes.
      </Text>
      <Text>
        Finally on the performance front Componentry is a very small, less thank 10Kb
        across the wire zipped, with no runtime CSS overhead. Experimental support exists
        for compiling presentational components down to HTML elements with CSS classes,
        getting you "closer to the metal".
      </Text>
      <Text>
      ...
      <Text>
        Componentry is a React component library designed specifically for building highly
        performant, completely customizable design systems.
      </Text>
    </DocsScreenLayout>
  )
}

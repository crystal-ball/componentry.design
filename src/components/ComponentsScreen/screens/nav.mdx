import { Anchor, Nav, Text } from 'componentry'
...
The Nav component creates a nav container that Anchor components are included in. Pass a
truthy `navItem` prop to the Anchor components for flex layouts. Flex layout props are
available on the Nav container for setting Anchor spacing and direction.

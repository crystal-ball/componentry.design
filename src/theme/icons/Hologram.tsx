export const Hologram = (props: React.ComponentPropsWithoutRef<'svg'>) => {
  return (
    <svg viewBox='0 0 970 796' {...props}>
      <title>hologram</title>
      <circle cx='917' cy='200' r='53' fill='#9E9E9E' opacity='0.3' />
      <circle cx='917' cy='200' r='30' fill='#1D1E7C' />
      <circle cx='882' cy='53' r='53' fill='#9E9E9E' opacity='0.3' />
      <circle cx='882' cy='53' r='30' fill='#1D1E7C' />
      <circle cx='53' cy='253' r='53' fill='#9E9E9E' opacity='0.3' />
      <circle cx='53' cy='253' r='30' fill='#1D1E7C' />
      <circle cx='100' cy='665' r='53' fill='#9E9E9E' opacity='0.3' />
      <circle cx='100' cy='665' r='30' fill='#1D1E7C' />
      <circle cx='172' cy='100' r='53' fill='#9E9E9E' opacity='0.3' />
      <circle cx='172' cy='100' r='30' fill='#1D1E7C' />
      <path
        ...
        fill='#E0E0E0'
      />
      <rect x='570' y='274.5' width='2' height='296.5' fill='#1D1E7C' />
      <rect x='570' y='147.40234' width='2' height='87.47168' fill='#1D1E7C' />
      <rect x='433' y='138.2749' width='2' height='432.7251' fill='#1D1E7C' />
      <rect x='467' y='100' width='2' height='97.45654' fill='#1D1E7C' />
      <rect x='467' y='244' width='2' height='296.6377' fill='#1D1E7C' />
      <path
        d='M584,638.75V846.43c-.66992-.05-1.33008-.12-2-.19V638.75Z'
        transform='translate(-115 -52)'
        fill='#1D1E7C'
      />
      <rect x='501' y='68' width='2' height='275.34668' fill='#1D1E7C' />
      <path
        d='M618,433.52V848c-.66992,0-1.33008,0-2-.01V433.52Z'
        transform='translate(-115 -52)'
        fill='#1D1E7C'
      />
      <rect x='535' y='100' width='2' height='382' fill='#1D1E7C' />
      <rect x='535' y='523' width='2' height='214.17285' fill='#1D1E7C' />
      <path
      ...
      <path
        ...
        fill='#1D1E7C'
      />
      <rect x='399' y='177' width='2' height='62.40967' fill='#1D1E7C' />
      <rect x='399' y='286.27539' width='2' height='284.72461' fill='#1D1E7C' />
      <rect x='365' y='200' width='2' height='371' fill='#1D1E7C' />
      <rect x='331' y='230' width='2' height='120.90527' fill='#1D1E7C' />
      <rect x='331' y='390.96826' width='2' height='180.03174' fill='#1D1E7C' />
      <rect x='297' y='262' width='2' height='201.53564' fill='#1D1E7C' />
      <rect x='297' y='501' width='2' height='70' fill='#1D1E7C' />
      <rect x='263' y='292' width='2' height='67.59863' fill='#1D1E7C' />
      <rect x='263' y='403.81885' width='2' height='167.18115' fill='#1D1E7C' />
      <rect x='229' y='308' width='2' height='263' fill='#1D1E7C' />
      <rect x='195' y='380' width='2' height='86.93701' fill='#1D1E7C' />
      <rect x='195' y='506.62207' width='2' height='64.37793' fill='#1D1E7C' />
      <rect x='590.37533' y='177' width='1.03675' height='377' fill='#1D1E7C' />
      <rect x='637' y='200' width='2' height='59.44092' fill='#1D1E7C' />
      <rect x='637' y='299.12598' width='2' height='271.87402' fill='#1D1E7C' />
      <rect x='671' y='257' width='2' height='35' fill='#1D1E7C' />
      <rect x='671' y='331.25195' width='2' height='173.8584' fill='#1D1E7C' />
      <rect x='671' y='540.6377' width='2' height='30.3623' fill='#1D1E7C' />
      <rect x='705' y='262' width='2' height='309' fill='#1D1E7C' />
      <rect x='739' y='292' width='2' height='98.96826' fill='#1D1E7C' />
      <rect x='739' y='428.38574' width='2' height='142.61426' fill='#1D1E7C' />
      <rect x='773' y='308' width='2' height='263' fill='#1D1E7C' />
      <path
      ...
      <path
        ...
        fill='#1D1E7C'
      />
      <rect x='804' y='380' width='2' height='86.93701' fill='#1D1E7C' />
      <rect x='804' y='506.62207' width='2' height='64.37793' fill='#1D1E7C' />
      <path
